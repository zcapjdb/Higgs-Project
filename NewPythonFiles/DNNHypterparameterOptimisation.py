...
#tfg.config.gpu.set_per_process_memory_fraction(0.4)
...
for nJets in [2,3]:
    ...
    if nJets == 2:
        ...
        dfEven = pd.read_csv('../dataset-and-plotting/CSV/VHbb_data_3jet_even.csv').head(119000)
        dfOdd = pd.read_csv('../dataset-and-plotting/CSV/VHbb_data_3jet_odd.csv').head(119000)
