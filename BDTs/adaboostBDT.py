...
for nJets in [2, 3]:
    ...
    bdtEven.fit(dfEven[variables], dfEven['Class'], sample_weight=np.abs(dfEven['training_weight']))
    bdtOdd.fit(dfOdd[variables], dfOdd['Class'], sample_weight=np.abs(dfOdd['training_weight']))
